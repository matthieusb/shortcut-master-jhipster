...
import static msn.shortcut.master.web.rest.TestUtil.sameInstant;
...
public class TrainingFollowedResourceIntTest {
    ...
    public void updateTrainingFollowed() throws Exception {
        ...
        TrainingFollowed updatedTrainingFollowed = trainingFollowedRepository.findById(trainingFollowed.getId()).get();
