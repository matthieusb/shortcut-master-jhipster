...
import msn.shortcut.master.repository.ExerciseVisitedRepository;
...
import msn.shortcut.master.domain.enumeration.ExercisePhase;
/**
...
public class ExerciseVisitedResourceIntTest {
    ...
    public void updateExerciseVisited() throws Exception {
        ...
        ExerciseVisited updatedExerciseVisited = exerciseVisitedRepository.findById(exerciseVisited.getId()).get();
