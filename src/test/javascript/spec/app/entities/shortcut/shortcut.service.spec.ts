    ...
    describe('Shortcut Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Shortcut', () => {
                service.create(new Shortcut(null)).subscribe(received => {
            ...
            it('should update a Shortcut', () => {
                service.update(new Shortcut(123)).subscribe(received => {
            ...
            it('should return a list of Shortcut', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Shortcut(123)]);
            });
