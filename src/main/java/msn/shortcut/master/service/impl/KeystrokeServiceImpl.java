...
import msn.shortcut.master.service.KeystrokeService;
import msn.shortcut.master.domain.Keystroke;
import msn.shortcut.master.repository.KeystrokeRepository;
...
public class KeystrokeServiceImpl implements KeystrokeService {
    ...
    @Override
    @Transactional(readOnly = true)
    public Optional<Keystroke> findOne(Long id) {
        log.debug("Request to get Keystroke : {}", id);
        return keystrokeRepository.findById(id);
    }
