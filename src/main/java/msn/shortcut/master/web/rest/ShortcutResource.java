...
public class ShortcutResource {
    ...
    @Timed
    public List<Shortcut> getAllShortcuts(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
    ...
    public ResponseEntity<Shortcut> getShortcut(@PathVariable Long id) {
        ...
        Optional<Shortcut> shortcut = shortcutService.findOne(id);
        return ResponseUtil.wrapOrNotFound(shortcut);
    }
