...
import msn.shortcut.master.service.ExerciseVisitedService;
...
public class ExerciseVisitedResource {
    ...
    @Timed
    public ResponseEntity<ExerciseVisited> createExerciseVisited(@RequestBody ExerciseVisited exerciseVisited) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<ExerciseVisited> updateExerciseVisited(@RequestBody ExerciseVisited exerciseVisited) throws URISyntaxException {
    ...
    public ResponseEntity<ExerciseVisited> getExerciseVisited(@PathVariable Long id) {
        ...
        Optional<ExerciseVisited> exerciseVisited = exerciseVisitedService.findOne(id);
        return ResponseUtil.wrapOrNotFound(exerciseVisited);
    }
